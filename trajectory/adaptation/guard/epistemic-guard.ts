...
export const assertValidationNoCorrectness = (v: any) => ({ ok: validationNoCorrectness(v), reason: validationNoCorrectness(v) ? undefined : "AdaptationValidation 弱语义：只记 changeObserved + 现实反馈，禁 changeWasCorrect/correct（变化发生了，非『印证我是对的』）" });

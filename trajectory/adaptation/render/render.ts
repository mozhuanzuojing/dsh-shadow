// dsh-shadow —— adaptation/render/render.ts：Adaptation 渲染（context / change / validation）。
import type { AdaptationContext, AdaptationChange, AdaptationValidation } from "../types/index.js";

export const renderContext = (ctx: AdaptationContext) => {
...
export const renderChange = (ch: AdaptationChange) => {
...
export const renderValidation = (v: AdaptationValidation) => {

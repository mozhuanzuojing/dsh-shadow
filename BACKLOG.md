...
> ⇒ **改为「判据 + 命令」，不再写复合计数**：现存 = **标题不带 ✅** 的条目。本次实测（v1.15.68）：
> `Select-String BACKLOG.md -Pattern '^### T\d+'` ⇒ 13 个标题，其中 `T12/T14/T16` 带 ✅ ⇒ **现存 T 10 条**
> （T2 / T3 / T6 / T7 / T9 / T10 / T11 / **T13 后半** / T15 —— 加 `T8` 已于 v1.15.64/65 结案）。

...
### T23. `references.md` §2（`browser-use/browser-use`）是否补一行指向「宿主原生面」的指针
...
### T24. `_research/`（12 个文件）的落点：留在仓内，还是按 `AGENTS.md` 出仓
...
### 🟡 D12. 归档层的「过期口径」 —— **已决策（2026-09-25 用户）：② 删数（归档层只留结论）**；⚠ **执行口径待定**

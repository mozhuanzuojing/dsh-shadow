import { type RecoverHandle } from "./loss.js";
/** 索引路径的默认恢复句柄（`_index.md` 自身）。传 `null` = 显式声明没有源路径。 */
export declare const INDEX_HANDLE: RecoverHandle;
 ...
 */
export declare const renderIndexBudgeted: (idx: string, maxChars: number, source?: RecoverHandle | null) => string;

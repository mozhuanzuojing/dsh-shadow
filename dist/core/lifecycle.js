...
export const sigmoid = (x) => 1 / (1 + Math.exp(-(x || 0)));
export const hotnessOf = (hits, ageDays, halfLife) => {
 ...
 */
export const lifecycleOf = (rec, ageDays, conflictCount, stale, superseded) => {
    if (rec?.pinned)
        return "TRUSTED";

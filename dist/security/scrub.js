...
export const isUnsafe = (line) => UNSAFE_CONTROL.test(String(line));
...
export const scrubUnsafeDoc = (s) => String(s || "").replace(UNSAFE_CONTROL_DOC, "");
...
export const isScaffoldBlock = (t) => {
...
export const referencedMaterials = (text) => {
    const out = [];
    const add = (x) => {

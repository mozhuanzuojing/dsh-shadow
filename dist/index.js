            ...
            toolsService.register({
                ...
                parameters: {
                    ...
                    properties: {
                        ...
                        mode: { type: "string", description: "模式开关（不传则按布尔参数分派）。常用：episode / decision / task / context / recall / query / query-log / shadow-report / shadow-manifest / index / knowledge / reflection / identity / temporal / offline / validate / evidence / timeline / verify。长程与边界族（agency-* / delegation-* / recall-* / adapt-* / horizon-* / federation* / reality* / model-* / world-* / simulate / candidate / execute / feedback / plan / distortion / stability / observer-* / workspace-* / continuity-index）的语义、入参与返回见 CONTEXT.md「mode 参考」。" },

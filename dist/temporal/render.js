...
export const renderNodePerception = (n) => {
...
export const renderNodeIdentityContext = (n) => {
    ...
    if (n.stateSnapshot.intent?.goal)
        lines.push(`intent ${n.stateSnapshot.intent.goal}`);
    return lines.join("\n");
};

// dsh-shadow —— core/admission/judgment.ts：Judgment（情境→决策→reason）。从 index.ts 迁出。
import { tokenize } from "../util.js";
import { readRel } from "../../persistence/files.js";
import { experienceOf } from "../view/experience.js";

export const judgmentOf = async (fs: any, ws: string, memories: any[], topic: string) => {
...
export const renderJudgment = (js: any[]) => {

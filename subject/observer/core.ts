// dsh-shadow —— subject/observer/core.ts：Observer Kernel（v0.20 根）。Observer 是"谁在看"的主体根。
...
import type { Identity, ObserverContext, ObserverState, RealityAnchor } from "../../core/types.js";
import { parseAsOf } from "../../core/util.js";
import { intentOf } from "../../core/admission/intent.js";

export const observerContextOf = (args: any, topic: string, identity: Identity | null, agentId?: string, state?: ObserverState): ObserverContext => {

...
// Shadow 只问 verifyEvidence(GatewayEvidenceRef)，不碰底层 fs/zg/git/...；provider 可选 fs/zg/额外注入。
...
export const routeVerify = (ref: GatewayEvidenceRef, ctx: any, providerName: string, extraProviders: Record<string, EvidenceProvider> = {}): Promise<EvidenceResult> => {

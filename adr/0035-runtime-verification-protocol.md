...
> 前置：ADR-0034（v1.0.0-alpha Observer Runtime Closure）。定位：**Observer Runtime Validation Phase**——不是 Capability Expansion，而是**验证 宪法（Constitution Set）在真实运行压力下是否保持成立**。

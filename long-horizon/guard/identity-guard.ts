...
export const assertResultNoIdentityChain = (r: string) => ({ ok: resultNoIdentityChain(r), reason: resultNoIdentityChain(r) ? undefined : "Adaptation Chain ≠ Identity Chain（100 次调整 ≠ 我是新主体；禁 self model expansion / identity evolution / 经历总和=我）" });

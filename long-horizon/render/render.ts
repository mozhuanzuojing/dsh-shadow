// dsh-shadow —— long-horizon/render/render.ts：Long Horizon 渲染（context / summary / event / link）。
import type { InteractionContext, HistorySummary, HistoryContinuityEvent, InteractionAdaptationLink } from "../types/index.js";

export const renderContext = (ctx: InteractionContext) => {
...
export const renderSummary = (s: HistorySummary) => {
...
export const renderEvent = (e: HistoryContinuityEvent) => {
...
export const renderLink = (l: InteractionAdaptationLink) => {
